        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('book.edit',['book'=>$book->id]) }}" class="btn btn-outline-success btn-sm btn-md text-uppercase" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"> @lang('Edit')</i></a>&nbsp;&nbsp;
                    @endif
