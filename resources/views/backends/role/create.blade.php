        ...
        <form action="{{ route('store_role') }}" method="POST" class="">
            ...
            <div class="clearfix">
                <div class="">
                    <div class="form-group col-12">
                        ...
                        <input type="text" name="name" class="form-control" style="position: relative;left:-12px" placeholder="@lang('Enter name')">
                    </div>
                </div>
            </div>
            <div>
            ...
            <div class="row">
                <div class="custom-control col-3 custom-switch">
                    <input type="checkbox" name="permissions[]" value="checked.all" class="custom-control-input toggle-status" id="checked_all" data-id="">
            ...
            <hr>
            <div class="user mt-4">@lang('User')</div>
            <div class="row">
                <div class="custom-control col-3 custom-switch">
                    <label style="position: absolute">@lang('View')</label>
            ...
            <hr>
            <button class="btn btn-success float-lg-right ml-2">@lang('Save')</button>
            <a href="{{ route('role.index') }}" class="btn btn-secondary float-lg-right">@lang('Cancel')</a>
        </form>
    </div>
</div>
<!-- switchery js -->
