            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <select name="customer_id" id="customer_id" class="form-control select2">
                        <option value="">{{ __('All Student') }}</option>
...
<div class="card">
    <div class="card-header text-uppercase">@lang('Borrow List')
        ...
        <div class="search-row mt-2 mb-2 col-sm-4 float-lg-right">
            <input type="text" name="search" id="search" value="{{ request('search') }}" class=" form-control search-box" autocomplete="off" placeholder="@lang('Search...')">
        </div>
    </div>
